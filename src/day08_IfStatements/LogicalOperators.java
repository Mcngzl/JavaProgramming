...
public class LogicalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean isEligible2 = creditScore >= 700 && age2 >= 21 && income>= 60000; // 3 ude dogru olmali
        ...
        boolean isEligible4 = countryOfBirth == "USA" || marriedToUsCitizen == true; // veya biri dogru olsa yeter
