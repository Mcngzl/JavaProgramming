...
public class ArraysUtility {
    ...
    //checks if the given integer is contained in the array =return boolean.contains(int[],int)
    ...
    //checks if the given double is contained in the array =return boolean.
    ...
    //checks if the given char is contained in the array =return boolean.
    ...
    //checks if the given String is contained in the array =return boolean.
